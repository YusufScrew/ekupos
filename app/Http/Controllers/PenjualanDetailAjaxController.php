...
class PenjualanDetailAjaxController extends Controller
{
    ...
    public function data($id)
    {
        ...
        foreach ($detail as $item) {
            ...
            $row['aksi']        = '<div class="btn-group">
                                    <button onclick="deleteData(`'. route('transaksi.destroy', $item->id_penjualan_detail) .'`)" class="btn btn-sm btn-icon me-2 btn-danger"><span class="tf-icons bx bx-trash"></span></button>
                                </div>';
            $data[] = $row;
