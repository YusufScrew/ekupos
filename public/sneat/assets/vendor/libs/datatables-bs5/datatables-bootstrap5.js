            ...
            n = function(e) {
                return function(e, t, a, r) {
                    ...
                    n.ext.renderer.pageButton.bootstrap = function(t, r, o, s, i, d) {
                        var l, c, u, f = new n.Api(t), p = t.oClasses, b = t.oLanguage.oPaginate, g = t.oLanguage.oAria.paginate || {}, m = 0, v = function(a, r) {
                            var n, s, u, x, y = function(t) {
                                t.preventDefault(),
                            ...
                            s = r.length; n < s; n++)
                                ...
                                Array.isArray(x))
                                    ...
                                    l && (u = e("<li>", {
                                        ...
                                        id: 0 === o && "string" == typeof x ? t.sTableId + "_" + x : null
                                    }).append(e("<a>", {
                                        href: "#",
                        ...
                        undefined !== u && e(r).find("[data-dt-idx=" + u + "]").trigger("focus")
                    }
                    ,
                    n
                }(e, window, document)
