        ...
        3333: function(t, n, e) {
            ...
            i = function(t) {
                return function(t, n, e, o) {
                    ...
                    i.ext.renderer.pageButton.bootstrap = function(n, o, s, r, a, l) {
                        var c, u, d, f = new i.Api(n), p = n.oClasses, b = n.oLanguage.oPaginate, h = n.oLanguage.oAria.paginate || {}, g = 0, m = function(e, o) {
                            var i, r, d, v, y = function(n) {
                                n.preventDefault(),
                                t(n.currentTarget).hasClass("disabled") || f.page() == n.data.action || f.page(n.data.action).draw("page")
                            };
                            for (i = 0,
                            r = o.length; i < r; i++)
                                if (v = o[i],
                                Array.isArray(v))
                                    ...
                                    c && (d = t("<li>", {
                                        ...
                                        id: 0 === s && "string" == typeof v ? n.sTableId + "_" + v : null
                                    }).append(t("<a>", {
                                        href: "#",
                        ...
                        try {
                            d = t(o).find(e.activeElement).data("dt-idx")
                        } catch (t) {}
                        m(t(o).empty().html('<ul class="pagination"/>').children("ul"), r),
                        undefined !== d && t(o).find("[data-dt-idx=" + d + "]").trigger("focus")
                    }
                    ,
                    i
                }(t, window, document)
                ...
                return function(t, n, e, o) {
                    ...
                    t.extend(d.prototype, {
                        ...
                        text: function(n, e) {
                            ...
                            return e === o ? c(i.conf.text) : (i.conf.text = e,
                            r ? l.children(r).eq(0).filter(":not(.dt-down-arrow)").html(c(e)) : l.html(c(e)),
                            this)
                        },
                        ...
                        _expandButton: function(n, e, i, s, r, a, l) {
                            ...
                            for (var f = 0, p = d.length; f < p; f++) {
                                var b = this._resolveExtends(d[f]);
                                if (b)
                                    if (u = !(b.config === o || !b.config.split),
                                    Array.isArray(b))
                                        this._expandButton(n, b, h !== o && h.conf !== o ? h.conf.split : o, s, l !== o && l.split !== o, a, l);
                                    else {
                                        var h = this._buildButton(b, s, b.split !== o || b.config !== o && b.config.split !== o, r);
                                        if (h) {
                                            if (a !== o && null !== a ? (n.splice(a, 0, h),
                                            a++) : n.push(h),
                                            h.conf.buttons || h.conf.split) {
                                                if (h.collection = t("<" + (u ? this.c.dom.splitCollection.tag : this.c.dom.collection.tag) + "/>"),
                                                h.conf._collection = h.collection,
                                                h.conf.split)
                                                    for (var g = 0; g < h.conf.split.length; g++)
                                                        "object" == typeof h.conf.split[g] && (h.conf.split[g].parent = l,
                                                        h.conf.split[g].collectionLayout === o && (h.conf.split[g].collectionLayout = h.conf.collectionLayout),
                                                        h.conf.split[g].dropup === o && (h.conf.split[g].dropup = h.conf.dropup),
                                                        h.conf.split[g].fade === o && (h.conf.split[g].fade = h.conf.fade));
                                                else
                                                    t(h.node).append(t('<span class="dt-down-arrow">' + this.c.dom.splitDropdown.text + "</span>"));
                                                this._expandButton(h.buttons, h.conf.buttons, h.conf.split, !u, u, a, h.conf)
                                            }
                                            h.conf.parent = l,
                                            b.init && b.init.call(c.button(h.node), c, t(h.node), b)
                                        }
                                    }
                            }
                        },
                        _buildButton: function(n, e, i, s) {
                            var l, c = this.c.dom.button, u = this.c.dom.buttonLiner, d = this.c.dom.collection, f = (this.c.dom.split,
                            this.c.dom.splitCollection), p = this.c.dom.splitDropdownButton, b = this.s.dt, h = function(t) {
                                return "function" == typeof t ? t(b, l, n) : t
                            };
                            if (n.spacer) {
                                var g = t("<span></span>").addClass("dt-button-spacer " + n.style + " " + c.spacerClass).html(h(n.text));
                                return {
                                    conf: n,
                                    node: g,
                                    inserter: g,
                            ...
                            if (!i && s && f ? c = p : !i && e && d.button && (c = d.button),
                            !i && s && f.buttonLiner ? u = f.buttonLiner : !i && e && d.buttonLiner && (u = d.buttonLiner),
                            ...
                            if (n.hasOwnProperty("html"))
                                ...
                                if (l = t("<" + v + "/>").addClass(c.className).addClass(s ? this.c.dom.splitDropdownButton.className : "").attr("tabindex", this.s.dt.settings()[0].iTabIndex).attr("aria-controls", this.s.dt.table().node().id).on("click.dtb", (function(t) {
                                    t.preventDefault(),
                                    !l.hasClass(c.disabled) && n.action && m(t, b, l, n),
                                    y && l.trigger("blur")
                                }
                                ...
                                u.tag) {
                                    var x = t("<" + u.tag + "/>").html(h(n.text)).addClass(u.className);
                                    "a" === u.tag.toLowerCase() && x.attr("href", "#"),
                                    l.append(x)
                                } else
                                    l.html(h(n.text));
                                !1 === n.enabled && l.addClass(c.disabled),
                                n.className && l.addClass(n.className),
                                n.titleAttr && l.attr("title", h(n.titleAttr)),
                                n.attr && l.attr(n.attr),
                                n.namespace || (n.namespace = ".dt-button-" + r++),
                                n.config !== o && n.config.split && (n.split = n.config.split)
                            }
                            var w, C, _ = this.c.dom.buttonContainer;
                            if (w = _ && _.tag ? t("<" + _.tag + "/>").addClass(_.className).append(l) : l,
                            this._addKey(n),
                            this.c.buttonCreated && (w = this.c.buttonCreated(n, w)),
                            i) {
                                (C = t("<div/>").addClass(this.c.dom.splitWrapper.className)).append(l);
                                var A = t.extend(n, {
                                ...
                                var k = function(n, e, o, i) {
                                  ...
                                  , B = t('<button class="' + this.c.dom.splitDropdown.className + ' dt-button"><span class="dt-btn-split-drop-arrow">' + this.c.dom.splitDropdown.text + "</span></button>").on("click.dtb", (function(t) {
                                    t.preventDefault(),
                                    t.stopPropagation(),
                                    B.hasClass(c.disabled) || k(t, b, B, A),
                                    y && B.trigger("blur")
                                }
                                )).on("keypress.dtb", (function(t) {
                                    13 === t.keyCode && (t.preventDefault(),
                                ...
                                0 === n.split.length && B.addClass("dtb-hide-drop"),
                                C.append(B).attr(A.attr)
                            }
                            return {
                                conf: n,
                                node: i ? C.get(0) : l.get(0),
                                inserter: i ? C : w,
                                buttons: [],
                                inCollection: e,
                                isSplit: i,
                        ...
                        _resolveExtends: function(n) {
                            ...
                            for (n = l(n); n && n.extend; ) {
                                ...
                                if (!c)
                                    return !1;
                                var u = c.className;
                                n.config !== o && c.config !== o && (n.config = t.extend({}, c.config, n.config)),
                                n = t.extend({}, c, n),
                                u && n.className !== u && (n.className = u + " " + n.className);
                        ...
                        _popover: function(o, i, s, r) {
                            var a = i
                              ...
                              , h = function() {
                                f = !0,
                                c(t(".dt-button-collection"), p.fade, (function() {
                                    t(this).detach()
                                }
                                )),
                                ...
                                d.background(!1, p.backgroundClassName, p.fade, b),
                            ...
                            if (!1 !== o) {
                                ...
                                g.length && (b.closest("div.dt-button-collection").length && (b = g.eq(0)),
                                h());
                                ...
                                b.parents("body")[0] !== e.body && (b = e.body.lastChild),
                                ...
                                l(y.insertAfter(b), p.fade);
                                var x = t(i.table().container())
                                  , w = y.css("position");
                                if ("container" !== p.span && "dt-container" !== p.align || (b = b.parent(),
                                y.css("width", x.width())),
                                "absolute" === w) {
                                    var C = t(b[0].offsetParent)
                                      , _ = b.position()
                                      , A = b.offset()
                                      , k = C.offset()
                                      , B = C.position()
                                      , T = n.getComputedStyle(C[0]);
                                    k.height = C.outerHeight(),
                                    k.width = C.width() + parseFloat(T.paddingLeft),
                                    k.right = k.left + k.width,
                                    k.bottom = k.top + k.height;
                                    var N = _.top + b.outerHeight()
                                      , D = _.left;
                                    y.css({
                                        top: N,
                                        left: D
                                    }),
                                    T = n.getComputedStyle(y[0]);
                                    var H = y.offset();
                                    H.height = y.outerHeight(),
                                    H.width = y.outerWidth(),
                                    H.right = H.left + H.width,
                                    H.bottom = H.top + H.height,
                                    H.marginTop = parseFloat(T.marginTop),
                                    H.marginBottom = parseFloat(T.marginBottom),
                                    p.dropup && (N = _.top - H.height - H.marginTop - H.marginBottom),
                                    ("button-right" === p.align || y.hasClass(p.rightAlignClassName)) && (D = _.left - H.width + b.outerWidth()),
                                    "dt-container" !== p.align && "container" !== p.align || (D < _.left && (D = -_.left),
                                    D + H.width > k.width && (D = k.width - H.width)),
                                    B.left + D + H.width > t(n).width() && (D = t(n).width() - H.width - B.left),
                                    A.left + D < 0 && (D = -A.left),
                                    B.top + N + H.height > t(n).height() + t(n).scrollTop() && (N = _.top - H.height - H.marginTop - H.marginBottom),
                                    B.top + N < t(n).scrollTop() && (N = _.top + b.outerHeight()),
                                    y.css({
                                        top: N,
                                        left: D
                                    })
                                ...
                                p.background && d.background(!0, p.backgroundClassName, p.fade, p.backgroundHost || b),
                    ...
                    d.background = function(n, i, s, r) {
                        s === o && (s = 400),
                        r || (r = e.body),
                        n ? l(t("<div/>").addClass(i).css("display", "none").insertAfter(r), s) : c(t("div." + i), s, (function() {
                        ...
                        for (var i = [], s = function(t, n, e) {
                            ...
                            if (Array.isArray(n) || n instanceof t)
                                ...
                                if (-1 !== n.indexOf(",")) {
                                    ...
                                    var f = t.map(c, (function(t) {
                                        return t.idx
                                    }
                                    ));
                                    i.push({
                                        inst: e,
                                        node: c[t.inArray(n, f)].node
                                    })
                    ...
                    var f = function(n) {
                      ...
                      , m = function(n, e) {
                        ...
                        for (var l = n.rows(i.rows, a).indexes().toArray(), c = n.cells(l, i.columns), u = c.render(i.orthogonal).toArray(), f = c.nodes().toArray(), p = s.length, b = [], h = 0, g = 0, m = p > 0 ? u.length / p : 0; g < m; g++) {
                            for (var v = [p], y = 0; y < p; y++)
                                v[y] = i.format.body(u[h], g, y, f[h]),
                                h++;
                            b[g] = v
                        }
                        var x = {
