                ...
                function k(p, v) {
                        ...
                        if (void 0 !== b.hourElement && void 0 !== b.minuteElement) {
                            ...
                            if (void 0 !== b.config.maxTime && void 0 !== b.config.minTime && b.config.minTime > b.config.maxTime) {
                                ...
                                if (i) {
                                    ...
                                    (e = Math.min(e, d.getHours())) === d.getHours() && (n = Math.min(n, d.getMinutes())),
                                    n === d.getMinutes() && (t = Math.min(t, d.getSeconds()))
                                }
                                if (a) {
                                    var u = void 0 !== b.config.minTime ? b.config.minTime : b.config.minDate;
                                    (e = Math.max(e, u.getHours())) === u.getHours() && n < u.getMinutes() && (n = u.getMinutes()),
                    ...
                    function j(e, n) {
                        var t = void 0 !== e ? b.parseDate(e) : b.latestSelectedDateObj || (b.config.minDate && b.config.minDate > b.now ? b.config.minDate : b.config.maxDate && b.config.maxDate < b.now ? b.config.maxDate : b.now)
                          ...
                          , i = b.currentMonth;
                        try {
                            void 0 !== t && (b.currentYear = t.getFullYear(),
                            b.currentMonth = t.getMonth())
                        } catch (e) {
                            e.message = "Invalid date supplied: " + t,
                            b.config.errorHandler(e)
                        }
                        n && b.currentYear !== a && (De("onYearChange"),
                        q()),
                        !n || b.currentYear === a && b.currentMonth === i || De("onMonthChange"),
                        b.redraw()
                    }
                    function H(e) {
                        var n = g(e);
                    ...
                    function R(e, n, t, a) {
                        ...
                        -1 === e.indexOf("hidden") && 0 === y(n, b.now) && (b.todayDateElem = o,
                        o.classList.add("today"),
                        o.setAttribute("aria-current", "date")),
                        i ? (o.tabIndex = -1,
                        we(n) && (o.classList.add("selected"),
                        b.selectedDateElem = o,
                        "range" === b.config.mode && (s(o, "startRange", b.selectedDates[0] && 0 === y(n, b.selectedDates[0], !0)),
                        ...
                        }(n) && !we(n) && o.classList.add("inRange"),
                    ...
                    function J(e, n) {
                        ...
                        void 0 === i ? b._input.focus() : a ? function(e, n) {
                            for (var t = -1 === e.className.indexOf("Month") ? e.dateObj.getMonth() : b.currentMonth, a = n > 0 ? b.config.showMonths : -1, i = n > 0 ? 1 : -1, o = t - b.currentMonth; o != a; o += i)
                                for (var r = b.daysContainer.children[o], l = t - b.currentMonth === o ? e.$i + n : n < 0 ? r.children.length - 1 : 0, c = r.children.length, s = l; s >= 0 && s < c && s != (n > 0 ? c : -1); s += i) {
                                    var d = r.children[s];
                    ...
                    function K(e, n) {
                        for (var t = (new Date(e,n,1).getDay() - b.l10n.firstDayOfWeek + 7) % 7, a = b.utils.getDaysInMonth((n - 1 + 12) % 12, e), i = b.utils.getDaysInMonth(n, e), o = window.document.createDocumentFragment(), r = b.config.showMonths > 1, l = r ? "prevMonthDay hidden" : "prevMonthDay", c = r ? "nextMonthDay hidden" : "nextMonthDay", s = a + 1 - t, u = 0; s <= a; s++,
                        u++)
                            o.appendChild(R("flatpickr-day " + l, new Date(e,n - 1,s), 0, u));
                        for (s = 1; s <= i; s++,
                        u++)
                            o.appendChild(R("flatpickr-day", new Date(e,n,s), 0, u));
                        for (var f = i + 1; f <= 42 - t && (1 === b.config.showMonths || u % 7 != 0); f++,
                        u++)
                    ...
                    function Z(e, n) {
                        ...
                        t < 0 && !0 === b._hidePrevMonthArrow || t > 0 && !0 === b._hideNextMonthArrow || (b.currentMonth += t,
                    ...
                    function ne(e, n) {
                        ...
                        if (b.config.minDate && a && y(a, b.config.minDate, void 0 !== n ? n : !b.minDateHasTime) < 0 || b.config.maxDate && a && y(a, b.config.maxDate, void 0 !== n ? n : !b.maxDateHasTime) > 0)
                            return !1;
                    ...
                    function ie(e) {
                        ...
                        if (13 === e.keyCode && t) {
                            if (a)
                                return b.setDate(b._input.value, !0, n === b.altInput ? b.config.altFormat : b.config.dateFormat),
                                b.close(),
                                n.blur();
                            b.open()
                        } else if (Q(n) || i || o) {
                            ...
                            case 8:
                            case 46:
                                t && !b.config.allowInput && (e.preventDefault(),
                                b.clear());
                                break;
                            case 37:
                            case 39:
                            ...
                            case 40:
                                ...
                                b.daysContainer && void 0 !== n.$i || n === b.input || n === b.altInput ? e.ctrlKey ? (e.stopPropagation(),
                                ee(b.currentYear - s),
                                J(B(1), 0)) : r || J(void 0, 7 * s) : n === b.currentYearElement ? ee(b.currentYear - s) : b.config.enableTime && (!r && b.hourElement && b.hourElement.focus(),
                                I(e),
                                b._debouncedChange());
                                break;
                            case 9:
                                if (r) {
                                    ...
                                    !b.config.noCalendar && b.daysContainer && b.daysContainer.contains(n) && e.shiftKey && (e.preventDefault(),
                                    b._input.focus())
                            }
                        }
                    ...
                    function oe(e, n) {
                        ...
                        1 === b.selectedDates.length && (!e || e.classList.contains(n) && !e.classList.contains("flatpickr-disabled"))) {
                            for (var t = e ? e.dateObj.getTime() : b.days.firstElementChild.dateObj.getTime(), a = b.parseDate(b.selectedDates[0], void 0, !0).getTime(), i = Math.min(t, b.selectedDates[0].getTime()), o = Math.max(t, b.selectedDates[0].getTime()), r = !1, l = 0, c = 0, s = i; s < o; s += x)
                            ...
                            Array.from(b.rContainer.querySelectorAll("*:nth-child(-n+" + b.config.showMonths + ") > ." + n)).forEach((function(n) {
                                ...
                                void 0 !== e && (e.classList.add(t <= b.selectedDates[0].getTime() ? "startRange" : "endRange"),
                    ...
                    function me(e) {
                        ...
                        if (void 0 !== n) {
                            ...
                            "single" === b.config.mode)
                                ...
                                0 !== y(a, b.selectedDates[0], !0) && b.selectedDates.sort((function(e, n) {
                    ...
                    b.clear = function(e, n) {
                        ...
                        !0 === n && (b.currentYear = b._initialDate.getFullYear(),
                    ...
                    b.updateValue = Ce,
                    b.open = function(e, n) {
                        if (void 0 === n && (n = b._positionElement),
                        !0 === b.isMobile) {
                            if (e) {
                                e.preventDefault();
                                var t = g(e);
                    ...
                    function Me() {
                        b.config.noCalendar || b.isMobile || !b.monthNav || (b.yearElements.forEach((function(e, n) {
                            var t = new Date(b.currentYear,b.currentMonth,1);
                            t.setMonth(b.currentMonth + n),
                            b.config.showMonths > 1 || "static" === b.config.monthSelectorType ? b.monthElements[n].textContent = h(t.getMonth(), b.config.shorthandCurrentMonth, b.l10n) + " " : b.monthsDropdownContainer.value = t.getMonth().toString(),
                    ...
                    return function() {
                        ...
                        function() {
                            ...
                            for (var u = 0; u < n.length; u++)
                                b.config[n[u]] = !0 === b.config[n[u]] || "true" === b.config[n[u]];
                            ...
                            u = 0; u < b.config.plugins.length; u++) {
                                ...
                                for (var m in f)
                                    t.indexOf(m) > -1 ? b.config[m] = c(f[m]).map(T).concat(b.config[m]) : void 0 === i[m] && (b.config[m] = f[m])
                            }
                        ...
                        b.utils = {
                            getDaysInMonth: function(e, n) {
                                ...
                                1 === e && (n % 4 == 0 && n % 100 != 0 || n % 400 == 0) ? 29 : b.l10n.daysInMonth[e]
                            }
                        },
                        b.isMobile || function() {
