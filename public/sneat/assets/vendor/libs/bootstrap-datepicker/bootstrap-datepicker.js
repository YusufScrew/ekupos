                ...
                h.prototype = {
                    ...
                    _process_options: function(e) {
                        ...
                        if (s.defaultViewDate instanceof Date || "string" == typeof s.defaultViewDate)
                            s.defaultViewDate = m.parseDate(s.defaultViewDate, o, s.language, s.assumeNearbyYear);
                    ...
                    fillMonths: function() {
                        for (var t = this._utc_to_local(this.viewDate), e = "", i = 0; i < 12; i++)
                            e += '<span class="month' + (t && t.getMonth() === i ? " focused" : "") + '">' + D[this.o.language].monthsShort[i] + "</span>";
                    ...
                    _fill_yearsView: function(i, a, s, n, o, r, h) {
                        for (var l, d, c, u = "", p = s / 10, f = this.picker.find(i), g = Math.floor(n / s) * s, D = g + 9 * p, m = Math.floor(this.viewDate.getFullYear() / p) * p, v = t.map(this.dates, (function(t) {
                            return Math.floor(t.getUTCFullYear() / p) * p
                        }
                        )), y = g - p; y <= D + p; y += p)
                            l = [a],
                            d = null,
                            y === g - p ? l.push("old") : y === D + p && l.push("new"),
                            -1 !== t.inArray(y, v) && l.push("active"),
                            (y < o || y > r) && l.push("disabled"),
                            y === m && l.push("focused"),
                            h !== t.noop && ((c = h(new Date(y,0,1))) === e ? c = {} : "boolean" == typeof c ? c = {
                                enabled: c
                            } : "string" == typeof c && (c = {
                                classes: c
                            }),
                    ...
                    fill: function() {
                        var s, n, o = new Date(this.viewDate), r = o.getUTCFullYear(), h = o.getUTCMonth(), l = this.o.startDate !== -1 / 0 ? this.o.startDate.getUTCFullYear() : -1 / 0, d = this.o.startDate !== -1 / 0 ? this.o.startDate.getUTCMonth() : -1 / 0, c = this.o.endDate !== 1 / 0 ? this.o.endDate.getUTCFullYear() : 1 / 0, u = this.o.endDate !== 1 / 0 ? this.o.endDate.getUTCMonth() : 1 / 0, p = D[this.o.language].today || D.en.today || "", f = D[this.o.language].clear || D.en.clear || "", g = D[this.o.language].titleFormat || D.en.titleFormat, v = a(), y = (!0 === this.o.todayBtn || "linked" === this.o.todayBtn) && v >= this.o.startDate && v <= this.o.endDate && !this.weekOfDateIsDisabled(v);
                        if (!isNaN(r) && !isNaN(h)) {
                            this.picker.find(".datepicker-days .datepicker-switch").text(m.formatDate(o, g, this.o.language)),
                            this.picker.find("tfoot .today").text(p).css("display", y ? "table-cell" : "none"),
                            ...
                            var F = D[this.o.language].monthsTitle || D.en.monthsTitle || "Months"
                              , O = this.picker.find(".datepicker-months").find(".datepicker-switch").text(this.o.maxViewMode < 2 ? F : r).end().find("tbody span").removeClass("active");
                            if (t.each(this.dates, (function(t, e) {
                                e.getUTCFullYear() === r && O.eq(e.getUTCMonth()).addClass("active")
                            }
                            )),
                    ...
                    navArrowsClick: function(e) {
                        ...
                        0 !== this.viewMode && (i *= 12 * m.viewModes[this.viewMode].navStep),
                  ...
                  , m = {
                    ...
                    parseDate: function(i, s, n, o) {
                        ...
                        if (i instanceof Date)
                            return i;
                        if ("string" == typeof s && (s = m.parseFormat(s)),
                        s.toValue)
                        ...
                        var g, v, y = {}, w = ["yyyy", "yy", "M", "MM", "m", "mm", "d", "dd"], k = {
                            yyyy: function(t, e) {
                        ...
                        r.length === b.length) {
                            ...
                            for (c = 0,
                            C = b.length; c < C; c++) {
                                if (g = parseInt(r[c], 10),
                                l = b[c],
                                isNaN(g))
                                    switch (l) {
                                    case "MM":
                                        v = t(D[n].months).filter(_),
                                        g = t.inArray(v[0], D[n].months) + 1;
                                        break;
                                    case "M":
                                        v = t(D[n].monthsShort).filter(_),
                                        g = t.inArray(v[0], D[n].monthsShort) + 1
                                    }
                                y[l] = g
                            }
                            for (c = 0; c < w.length; c++)
                                (M = w[c])in y && !isNaN(y[M]) && (T = new Date(i),
                                k[M](T, y[M]),
                                isNaN(T) || (i = T))
                        }
                        return i
                    ...
                    formatDate: function(e, i, a) {
                        if (!e)
                            return "";
                        if ("string" == typeof i && (i = m.parseFormat(i)),
                        i.toDisplay)
