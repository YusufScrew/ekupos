!function() {
    ...
    !function() {
        ...
        function P(e, t, n) {
            for (var o in t)
                "__proto__" !== o && "constructor" !== o && (o in e ? "string" == typeof e[o] || e[o]instanceof String || "string" == typeof t[o] || t[o]instanceof String ? n && (e[o] = t[o]) : P(e[o], t[o], n) : e[o] = t[o]);
            return e
        }
        function L(e) {
            return e.replace(/[\-\[\]\/\{\}\(\)\*\+\?\.\\\^\$\|]/g, "\\$&")
        ...
        var I = function(e) {
            ...
            return o(s, [{
                ...
                value: function(e, t, n) {
                    ...
                    var s = S(this.data, a);
                    return s || !i || "string" != typeof n ? s : A(this.data && this.data[e] && this.data[e][t], n, r)
                }
            }, {
                key: "addResource",
                value: function(e, t, n, o) {
                ...
                value: function(e, t) {
                    ...
                    "v1" === this.options.compatibilityAPI ? D(D({}, {}), this.getResource(e, t)) : this.getResource(e, t)
                }
            }, {
        ...
        var M = {}
          , B = function(n) {
            ...
            function f(e) {
                ...
                n = s.call(this),
                C && m.call(a(n)),
                O(["resourceStore", "languageUtils", "pluralResolver", "interpolator", "backendConnector", "i18nFormat", "utils"], e, a(n)),
                n.options = o,
                void 0 === n.options.keySeparator && (n.options.keySeparator = "."),
            ...
            return o(f, [{
                ...
                value: function(t, n, o) {
                    ...
                    if (p && "cimode" === p.toLowerCase()) {
                        if (h) {
                            ...
                            return i ? (g.res = "".concat(l).concat(d).concat(u),
                    ...
                    if (k && y && x && w.indexOf(b) < 0 && ("string" != typeof O || "[object Array]" !== b)) {
                        if (!n.returnObjects && !this.options.returnObjects) {
                            ...
                            var S = this.options.returnedObjectHandler ? this.options.returnedObjectHandler(v, y, _(_({}, n), {}, {
                                ns: c
                        ...
                        var F = n.missingKeyNoValueFallbackToKey || this.options.missingKeyNoValueFallbackToKey
                          , U = F && N ? void 0 : y
                          , M = D && I !== y && this.options.updateMissing;
                        if (N || C || M) {
                            if (this.logger.log(M ? "updateKey" : "missingKey", p, l, u, M ? I : y),
                            a) {
                                var B = this.resolve(u, _(_({}, n), {}, {
                                    keySeparator: !1
                                }));
                            ...
                            var K = function(e, t, o) {
                                var i = D && o !== y ? o : U;
                                r.options.missingKeyHandler ? r.options.missingKeyHandler(e, l, t, i, M, n) : r.backendConnector && r.backendConnector.saveMissing && r.backendConnector.saveMissing(e, l, t, i, M, n),
                                r.emit("missingKey", e, l, t, y)
                            };
                            this.options.saveMissing && (this.options.saveMissingPlurals && T ? H.forEach((function(e) {
                                r.pluralResolver.getSuffixes(e, n).forEach((function(t) {
                                    K([e], u + t, n["defaultValue".concat(t)] || I)
                                }
                                ))
                            }
                            )) : K(H, u, I))
                        ...
                        N && y === u && this.options.appendNamespaceToMissingKey && (y = "".concat(l, ":").concat(u)),
                        (N || C) && this.options.parseMissingKeyHandler && (y = "v1" !== this.options.compatibilityAPI ? this.options.parseMissingKeyHandler(this.options.appendNamespaceToMissingKey ? "".concat(l, ":").concat(u) : u, C ? y : void 0) : this.options.parseMissingKeyHandler(y))
                    }
                    return i ? (g.res = y,
                    g) : y
                }
                ...
                value: function(e, t, n, o, r) {
                    ...
                    if (this.i18nFormat && this.i18nFormat.parse)
                        e = this.i18nFormat.parse(e, _(_({}, this.options.interpolation.defaultVariables), n), o.usedLng, o.usedNS, o.usedKey, {
                            resolved: o
                        });
                    else if (!n.skipInterpolation) {
                        n.interpolation && this.interpolator.init(_(_({}, n), {
                            interpolation: _(_({}, this.options.interpolation), n.interpolation)
                        }));
                        ...
                        if (this.options.interpolation.defaultVariables && (c = _(_({}, this.options.interpolation.defaultVariables), c)),
                    ...
                    return null != e && p && p.length && !1 !== n.applyPostProcessor && (e = F.handle(p, e, t, this.options && this.options.postProcessPassResolved ? _({
                        i18nResolved: o
                    }, n) : n, this)),
                    e
                }
            ...
            return o(e, [{
                ...
                value: function(e) {
                    if ("string" == typeof e && e.indexOf("-") > -1) {
                        ...
                        n[1] = n[1].toUpperCase(),
                        t.indexOf(n[1].toLowerCase()) > -1 && (n[1] = H(n[1].toLowerCase()))) : 3 === n.length && (n[0] = n[0].toLowerCase(),
        ...
        var Y = function() {
            ...
            return o(e, [{
                ...
                value: function(e, t, n, o) {
                    ...
                    var l = function(e) {
                        if (e.indexOf(s.formatSeparator) < 0) {
                            var r = j(t, u, e);
                            return s.alwaysFormat ? s.format(r, void 0, n, W(W(W({}, o), t), {}, {
                                interpolationkey: e
                            })) : r
                        }
                        ...
                        return s.format(j(t, u, a), c, n, W(W(W({}, o), t), {}, {
                            interpolationkey: a
                        }))
                    };
                    this.resetRegExp();
                ...
                key: "nest",
                value: function(e, t) {
                    var n, o, r = this, i = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {}, a = W({}, i);
                    function s(e, t) {
                    ...
                    delete a.defaultValue; n = this.nestingRegexp.exec(e); ) {
                        ...
                        c && (o = u.reduce((function(e, t) {
                            return r.format(e, t, i.lng, W(W({}, i), {}, {
            ...
            function e() {
                ...
                this.formats = {
                    ...
                    currency: function(e, t, n) {
                        return new Intl.NumberFormat(t,Z(Z({}, n), {}, {
                            style: "currency"
                        })).format(e)
                    },
                    datetime: function(e, t, n) {
                        return new Intl.DateTimeFormat(t,Z({}, n)).format(e)
                    },
                    relativetime: function(e, t, n) {
                        return new Intl.RelativeTimeFormat(t,Z({}, n)).format(e, n.range || "day")
                    },
                    list: function(e, t, n) {
        ...
        var oe = function(e) {
            ...
            function s(e, n, o) {
                var r, u = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : {};
                return t(this, s),
                r = i.call(this),
                C && m.call(a(r)),
                r.backend = e,
                ...
                r.retryTimeout = u.retryTimeout >= 1 ? u.retryTimeout : 350,
                r.state = {},
                r.queue = [],
                r.backend && r.backend.init && r.backend.init(o, u.backend, u),
                r
            }
            return o(s, [{
                key: "queueLoad",
            ...
            return o(f, [{
                ...
                value: function() {
                    ...
                    !this.options.isClone) {
                        ...
                        this.modules.formatter ? i = this.modules.formatter : "undefined" != typeof Intl && (i = ee);
                        ...
                        s.backendConnector = new oe(r(this.modules.backend),s.resourceStore,s,this.options),
        ...
        var de = []
          ...
          , ye = de.slice;
        function ve(e) {
            return ge.call(ye.call(arguments, 1), (function(t) {
                if (t)
                    for (var n in t)
                        void 0 === e[n] && (e[n] = t[n])
            }
        ...
        function me() {
            return "function" == typeof XMLHttpRequest || "object" === ("undefined" == typeof XMLHttpRequest ? "undefined" : he(XMLHttpRequest))
        }
        var be, we, Oe, ke = r(3154), xe = r.t(ke, 2);
        function Se(e) {
        ...
        "function" == typeof fetch && (be = "undefined" != typeof global && global.fetch ? global.fetch : "undefined" != typeof window && window.fetch ? window.fetch : fetch),
        me() && ("undefined" != typeof global && global.XMLHttpRequest ? we = global.XMLHttpRequest : "undefined" != typeof window && window.XMLHttpRequest && (we = window.XMLHttpRequest)),
        "function" == typeof ActiveXObject && ("undefined" != typeof global && global.ActiveXObject ? Oe = global.ActiveXObject : "undefined" != typeof window && window.ActiveXObject && (Oe = window.ActiveXObject)),
        ...
        var je = function(e, t) {
          ...
          , Re = function(e, t, n, o) {
            ...
            be ? function(e, t, n, o) {
                ...
                var r = ve({}, "function" == typeof e.customHeaders ? e.customHeaders() : e.customHeaders);
            ...
            }(e, t, n, o) : me() || "function" == typeof ActiveXObject ? function(e, t, n, o) {
                n && "object" === Se(n) && (n = je("", n).slice(1)),
                e.queryStringParams && (t = je(t, e.queryStringParams));
                try {
                    var r;
                    (r = we ? new we : new Oe("MSXML2.XMLHTTP.3.0")).open(n ? "POST" : "GET", t, 1),
            ...
            n = [{
                ...
                value: function(e) {
                    var t = this
                      ...
                      , o = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {};
                    this.services = e,
                    this.options = ve(n, this.options || {}, Ne()),
                    this.allOptions = o,
        ...
        var De = Te
          ...
          , Fe = Ae.slice;
        function Ue(e) {
            return Ie.call(Fe.call(arguments, 1), (function(t) {
                if (t)
                    for (var n in t)
                        void 0 === e[n] && (e[n] = t[n])
            }
        ...
        var _e = /^[\u0009\u0020-\u007e\u0080-\u00ff]+$/
          ...
          , Ke = {
            ...
            cacheUserLanguage: function(e, t) {
                t.lookupLocalStorage && Ve() && window.localStorage.setItem(t.lookupLocalStorage, e)
            }
        }
          , ze = null
          , Je = function() {
            if (null !== ze)
                return ze;
            try {
                ze = "undefined" !== window && null !== window.sessionStorage;
                var e = "i18next.translate.boo";
          ...
          , Xe = {
            ...
            cacheUserLanguage: function(e, t) {
                t.lookupSessionStorage && Je() && window.sessionStorage.setItem(t.lookupSessionStorage, e)
            }
        }
          , $e = {
            name: "navigator",
