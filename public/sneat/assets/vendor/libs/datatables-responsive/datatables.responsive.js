                ...
                return function(e, t, n, r) {
                    ...
                    var i = e.fn.dataTable
                      , s = function(t, n) {
                        ...
                        this.c = e.extend(!0, {}, s.defaults, i.defaults.responsive, n),
                        t.responsive = this,
                        this._constructor())
                    };
                    e.extend(s.prototype, {
                        _constructor: function() {
                            ...
                            e(t).on("resize.dtr orientationchange.dtr", i.util.throttle((function() {
                                var r = e(t).innerWidth();
                                r !== o && (n._resize(),
                                o = r)
                            }
                            ))),
                            s.oApi._fnCallbackReg(s, "aoRowCreatedCallback", (function(t, i, s) {
                        ...
                        _columnsVisiblity: function(t) {
                            var n, r, i = this.s.dt, s = this.s.columns, o = s.map((function(e, t) {
                                return {
                                    columnIdx: t,
                                    priority: e.priority
                                }
                            ...
                            r = o.length; n < r; n++) {
                                var h = o[n].columnIdx;
                                "-" === a[h] && !s[h].control && s[h].minWidth && (p || u - s[h].minWidth < 0 ? (p = !0,
                                a[h] = !1) : a[h] = !0,
                                u -= s[h].minWidth)
                            }
                            var f = !1;
                        ...
                        _classLogic: function() {
                            var t = this
                              ...
                              , i = this.s.dt
                              , s = i.columns().eq(0).map((function(e) {
                                var t = this.column(e)
                              ...
                              , a = function(e, r, i, a) {
                                ...
                                if (i) {
                                    ...
                                    s[e].includeIn.push(r)
                            };
                            s.each((function(t, r) {
                                for (var i = t.className.split(" "), s = !1, o = 0, d = i.length; o < d; o++) {
                                    var l = i[o].trim();
                                    if ("all" === l || "dtr-all" === l)
                                        return s = !0,
                                    ...
                                    e.each(n, (function(e, t) {
                                        var n = t.name.split("-")
                                          ...
                                          , o = l.match(i);
                                        o && (s = !0,
                                        o[2] === n[0] && o[3] === "-" + n[1] ? a(r, t.name, o[1], o[2] + o[3]) : o[2] !== n[0] || o[3] || a(r, t.name, o[1], o[2]))
                                    }
                                    ))
                                }
                                s || (t.auto = !0)
                        ...
                        _detailsDisplay: function(t, n) {
                            ...
                            if (o && !1 !== o.type) {
                                ...
                                !0 !== d && !1 !== d || e(i.table().node()).triggerHandler("responsive-display.dt", [i, t, d, n])
                            }
                        },
                        _detailsInit: function() {
                            var t = this
                              , n = this.s.dt
                              , i = this.c.details;
                            "inline" === i.type && (i.target = "td.dtr-control, th.dtr-control"),
                            ...
                            s === r && null === s || e(n.table().body()).on("click.dtr mousedown.dtr mouseup.dtr", o, (function(r) {
                                if (e(n.table().node()).hasClass("collapsed") && -1 !== e.inArray(e(this).closest("tr").get(0), n.rows().nodes().toArray())) {
                                    ...
                                    "click" === r.type ? t._detailsDisplay(o, !1) : "mousedown" === r.type ? e(this).css("outline", "none") : "mouseup" === r.type && e(this).trigger("blur").css("outline", "")
                                }
                            }
                            ))
                        },
                            ...
                            return e.map(this.s.columns, (function(i, s) {
                                if (!i.never && !i.control) {
                                    ...
                                    return {
                                        ...
                                        rowIndex: t,
                                        title: null !== o.sTitle ? o.sTitle : e(r.column(s).header()).text()
                                    }
                                }
                            }
                            ))
                        ...
                        _resize: function(n) {
                            var r, i, s = this, o = this.s.dt, a = e(t).innerWidth(), d = this.c.breakpoints, l = d[0].name, c = this.s.columns, u = this.s.current.slice();
                            ...
                            for (r = 0,
                            i = c.length; r < i; r++)
                                if (!1 === p[r] && !c[r].never && !c[r].control && 0 == !o.column(r).visible()) {
                                    h = !0;
                                    break
                                }
                            ...
                            f && (this._redrawChildren(),
                            e(o.table().node()).trigger("responsive-resize.dt", [o, this.s.current]),
                            0 === o.page.info().recordsDisplay && e("td", o.table().body()).eq(0).attr("colspan", v)),
                            s._controlClass()
                        },
                        _resizeAuto: function() {
                            ...
                            if (this.c.auto && -1 !== e.inArray(!0, e.map(n, (function(e) {
                                ...
                                "inline" === this.c.details.type && e(r).addClass("dtr-inline collapsed"),
                        ...
                        _setColumnVis: function(t, n) {
                            var r = this.s.dt
                              , i = n ? "" : "none";
                            e(r.column(t).header()).css("display", i).toggleClass("dtr-hidden", !n),
                            e(r.column(t).footer()).css("display", i).toggleClass("dtr-hidden", !n),
                            r.column(t).nodes().to$().css("display", i).toggleClass("dtr-hidden", !n),
                            e.isEmptyObject(o) || r.cells(null, t).indexes().each((function(e) {
                                a(r, e.row, e.column)
                            }
                            ))
                        },
                        _tabIndexes: function() {
                            ...
                            "number" == typeof i ? t.cells(null, i, {
                                page: "current"
                    ...
                    function a(e, t, n) {
                        var i = t + "-" + n;
                        if (o[i]) {
                            for (var s = e.cell(t, n).node(), a = o[i][0].parentNode.childNodes, d = [], l = 0, c = a.length; l < c; l++)
                                d.push(a[l]);
                    ...
                    s.renderer = {
                        listHiddenNodes: function() {
                            return function(t, n, r) {
                                var i = e('<ul data-dtr-index="' + n + '" class="dtr-details"/>')
                                  , s = !1;
                                return e.each(r, (function(n, r) {
                                    if (r.hidden) {
                                        var a = r.className ? 'class="' + r.className + '"' : "";
                                        e("<li " + a + ' data-dtr-index="' + r.columnIndex + '" data-dt-row="' + r.rowIndex + '" data-dt-column="' + r.columnIndex + '"><span class="dtr-title">' + r.title + "</span> </li>").append(e('<span class="dtr-data"/>').append(function(e, t, n) {
                                            var r = t + "-" + n;
                                            if (o[r])
                                                return o[r];
                                            for (var i = [], s = e.cell(t, n).node().childNodes, a = 0, d = s.length; a < d; a++)
                                                i.push(s[a]);
                                            return o[r] = i,
                                            i
                                        }(t, r.rowIndex, r.columnIndex))).appendTo(i),
                                        s = !0
                                    }
                                }
                                )),
