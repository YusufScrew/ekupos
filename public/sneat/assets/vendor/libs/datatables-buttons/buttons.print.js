                ...
                return function(t, n, e, o) {
                    ...
                    var i = t.fn.dataTable
                      ...
                      , r = function(t) {
                        s.href = t;
                        var n = s.host;
                        return -1 === n.indexOf("/") && 0 !== s.pathname.indexOf("/") && (n += "/"),
                        s.protocol + "//" + n + s.pathname + s.search
                    };
                    return i.ext.buttons.print = {
                        ...
                        action: function(e, o, i, s) {
                            var a = o.buttons.exportData(t.extend({
                                decodeEntities: !1
                            }, s.exportOptions))
                              , l = o.buttons.exportInfo(s)
                              , u = o.columns(s.exportOptions.columns).flatten().map((function(t) {
                                return o.settings()[0].aoColumns[o.column(t).index()].sClass
                            }
                            )).toArray()
                              , c = function(t, n) {
                                for (var e = "<tr>", o = 0, i = t.length; o < i; o++) {
                                    var s = null === t[o] || undefined === t[o] ? "" : t[o];
                                    e += "<" + n + " " + (u[o] ? 'class="' + u[o] + '"' : "") + ">" + s + "</" + n + ">"
                                }
                                return e + "</tr>"
                            }
                              , d = '<table class="' + o.table().node().className + '">';
                            s.header && (d += "<thead>" + c(a.header, "th") + "</thead>"),
                            d += "<tbody>";
                            for (var f = 0, p = a.body.length; f < p; f++)
                                d += c(a.body[f], "td");
                            d += "</tbody>",
                            s.footer && a.footer && (d += "<tfoot>" + c(a.footer, "th") + "</tfoot>"),
                            d += "</table>";
                            var h = n.open("", "");
                            if (h) {
                                h.document.close();
                                var b = "<title>" + l.title + "</title>";
                                t("style, link").each((function() {
                                    var n;
                                    b += ("link" === (n = t(this).clone()[0]).nodeName.toLowerCase() && (n.href = r(n.href)),
                                    n.outerHTML)
                                }
                                ));
                                try {
                                    h.document.head.innerHTML = b
                                } catch (e) {
                                    t(h.document.head).html(b)
                                }
                                h.document.body.innerHTML = "<h1>" + l.title + "</h1><div>" + (l.messageTop || "") + "</div>" + d + "<div>" + (l.messageBottom || "") + "</div>",
                                t(h.document.body).addClass("dt-print-view"),
                                t("img", h.document.body).each((function(t, n) {
                                    n.setAttribute("src", r(n.getAttribute("src")))
                                }
                                )),
                                s.customize && s.customize(h, s, o);
                                var g = function() {
                                    s.autoPrint && (h.print(),
                                    h.close())
                                };
                                navigator.userAgent.match(/Trident\/\d.\d/) ? g() : h.setTimeout(g, 1e3)
                            } else
                    ...
                    t.extend(d.prototype, {
                        ...
                        _popover: function(o, i, s, r) {
                            ...
                            if (!1 !== o) {
                                ...
                                y.css("width", x.width())),
                                "absolute" === w) {
                                    var C = t(h[0].offsetParent)
                                      , _ = h.position()
                                      , A = h.offset()
                                      , k = C.offset()
                                      , T = C.position()
                                      , B = n.getComputedStyle(C[0]);
                                    k.height = C.outerHeight(),
                                    k.width = C.width() + parseFloat(B.paddingLeft),
                                    k.right = k.left + k.width,
                                    k.bottom = k.top + k.height;
                                    var N = _.top + h.outerHeight()
                                      , H = _.left;
                                    y.css({
                                        top: N,
                                        left: H
                                    ...
                                    var L = y.offset();
                                    L.height = y.outerHeight(),
                                    L.width = y.outerWidth(),
                                    L.right = L.left + L.width,
                                    L.bottom = L.top + L.height,
                                    L.marginTop = parseFloat(B.marginTop),
                                    L.marginBottom = parseFloat(B.marginBottom),
                                    p.dropup && (N = _.top - L.height - L.marginTop - L.marginBottom),
                                    ("button-right" === p.align || y.hasClass(p.rightAlignClassName)) && (H = _.left - L.width + h.outerWidth()),
                                    "dt-container" !== p.align && "container" !== p.align || (H < _.left && (H = -_.left),
                                    H + L.width > k.width && (H = k.width - L.width)),
                                    T.left + H + L.width > t(n).width() && (H = t(n).width() - L.width - T.left),
                                    A.left + H < 0 && (H = -A.left),
                                    T.top + N + L.height > t(n).height() + t(n).scrollTop() && (N = _.top - L.height - L.marginTop - L.marginBottom),
                                    T.top + N < t(n).scrollTop() && (N = _.top + h.outerHeight()),
                                    y.css({
                                        top: N,
                                        left: H
                                    })
